...
export default function Newsletter() {
  ...
  return (
    <section className="container flex items-center justify-center px-5 gap-40 py-[150px] pb-[75px] max-[768px]:pb-[0px] max-[768px]:flex-col max-[768px]:gap-20 max-[500px]:gap-10">
      ...
      <div className="w-1/2 max-[768px]:w-[85%]">
        ...
        >
          <input
            type="email"
            className="news-text font-sans font-semibold text-dark_blue bg-white border-2 max-w-[375px] border-dark_blue rounded-lg p-2 mb-8 w-full focus:border-blue-800 placeholder:max-[768px]:text-[14px] max-[768px]:my-4"
            value={email}
            onChange={(e) => setEmail(e.target.value)}
            placeholder="Enter your email..."
          />
          <button className="news-text text-white bg-dark_blue w-[140px] h-[50px] rounded-[15px] block hover:bg-opacity-85 max-[768px]:mx-auto max-[768px]:w-[110px] max-[768px]:h-[50px] max-[768px]:text-[14px]">
