...
export default function Structure() {
  return (
    <>
      ...
      <div className="container mx-auto grid xl:grid-cols-4 min-[561px]:grid-cols-2 gap-x-6 gap-y-4 mt-10 mb-28">
        {packages.map((p, idx) => (
          <motion.div
            initial={{
              opacity: 0,
          ...
          >
            ...
            <div className="pl-5 pt-5 space-y-2">
              <h4 className="text-dark_blue">For {p.scale}</h4>
              <h2 className="text-xl text-dark_blue">{p.name}</h2>
            </div>

            <div className="pl-5 mt-20 font-sans font-semibold">
              ...
              <div className="text-gray opacity-80 mt-4 space-y-4">
                {p?.no_services?.map((s, idx) => (
                  ...
                  >
                    <div className="w-7 h-7">
                      <MinusCircle size={28} className="text-gray opacity-80" />
                    </div>
                    <span className="text-base">{s}</span>
                  </div>
                ))}
            ...
            <Link
              href={"/contact"}
              className="text-white w-fit bg-dark_blue px-6 py-3 rounded-md block mx-auto my-4 mt-6 transition duration-300 ease-in hover:bg-opacity-85"
            >
              Get Started
            </Link>
          </motion.div>
      ...
      <section className="max-[680px]:px-4 bg-light_blue py-16 mt-10">
        <div className="flex max-[680px]:flex-col-reverse items-center justify-between container mx-auto gap-10">
          <div className="max-[680px]:text-center">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="font-sans font-semibold text-dark_blue text-2xl my-3"
            >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="font-sans font-semibold text-body text-2xl max-w-[450px]"
            >
