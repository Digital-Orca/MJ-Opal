    ...
    <main className="min-h-screen">
      ...
      <div className="container mx-auto grid xl:grid-cols-4 min-[561px]:grid-cols-2 gap-x-6 gap-y-4 mt-10">
        {packages.map((p, idx) => (
          ...
          >
            <div className="absolute -top-24 inset-x-0 -z-10 max-[970px]:-top-16 max-[850px]:-top-10 max-[750px]:-top-4 max-[630px]:top-0 max-[560px]:-top-24 max-[490px]:-top-14 max-[420px]:-top-6 max-[370px]:top-0">
              <Image
                className="w-full"
                src={SERVICE_WAVE}
            ...
            <button className="text-white bg-dark_blue px-6 py-3 rounded-md block mx-auto my-4 mt-6 transition duration-300 ease-in hover:bg-opacity-85">
              Get Started
            </button>
          </motion.div>
        ))}
